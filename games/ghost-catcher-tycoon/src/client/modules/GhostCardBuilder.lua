...
function GhostCardBuilder:createTemplate()
	...
	cardTemplate.Size = UDim2.new(0, 200, 0, 120)
	...
	energyLabel.Position = UDim2.new(0, 4, 0, 45)
...
function GhostCardBuilder:buildCard(ghostData, parentContainer, callbacks)
	...
	card.Name = "GhostCard_" .. (ghostData.id or "unknown")
	...
	card.MouseEnter:Connect(function()
		local hoverTween = TweenService:Create(card, TweenInfo.new(0.15, Enum.EasingStyle.Quad), { Size = UDim2.new(0, 210, 0, 130) })
		hoverTween:Play()
	end)

	card.MouseLeave:Connect(function()
		local resetTween = TweenService:Create(card, TweenInfo.new(0.15, Enum.EasingStyle.Quad), { Size = UDim2.new(0, 200, 0, 120) })
		resetTween:Play()
	end)
