--==============================--
-- ISLAND 09: PHANTOM FORTRESS
--==============================--
-- Theme: Haunted fortress with tombstones
-- Difficulty: Very Hard
-- Boss-heavy zone with maximum challenge
--==============================--
...
local ISLAND_DATA = {
	...
	position = Vector3.new(500, 10, 2500),
	terrainMaterial = Enum.Material.Slate,
	size = 350,
	obstacleType = "tombstones",
}
...
local function createIsland(parentFolder)
	...
	for i = 1, obstacleCount do
		...
		local tombstone = Props.createTombstone(Vector3.new(randomX, ISLAND_DATA.position.Y + 20, randomZ))
		tombstone.Parent = obstaclesFolder
	end

	print("[WorldBuilder] ✅ Island created: " .. ISLAND_DATA.name .. " with " .. obstacleCount .. " tombstones")
	return islandFolder
end
